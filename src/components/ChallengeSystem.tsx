 ...
 * 段階的な問題で論理回路を学習
 */
const ChallengeSystem: React.FC<ChallengeSystemProps> = ({ gates, connections, onComplete }) => {
  ...
  // 簡易シミュレーション
  const simulateCircuit = (testGates: Gate[], testConnections: Connection[]): Record<string, boolean> => {
