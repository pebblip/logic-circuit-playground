...
interface ExtendedChallengeSystemProps {
  gates: Gate[];
 ...
 * - デバッグモード付き
 */
const ExtendedChallengeSystem: React.FC<ExtendedChallengeSystemProps> = ({ gates, connections, onComplete, debugMode = false }) => {
