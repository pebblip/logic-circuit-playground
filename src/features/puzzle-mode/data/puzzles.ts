...
export const PUZZLES: Puzzle[] = [
  // === 初級: 基本論理ゲート ===
  {
    ...
    title: 'NOTの世界',
    description:
      'Aの反対の値を出力してください。シンプルですが、すべての論理の基本です。',
    difficulty: 'beginner',
    category: 'logic',
    constraints: {
      maxGates: 2,
...

  {
    ...
    title: 'ANDの条件',
    description:
      'AとBが両方ともONの時だけONを出力してください。すべてが満たされた時の論理です。',
    difficulty: 'beginner',
    category: 'logic',
    constraints: {
      maxGates: 4,
...

  {
    ...
    title: 'ORの選択',
    description:
      'AまたはBのどちらかがONの時にONを出力してください。選択肢がある論理です。',
    difficulty: 'beginner',
    category: 'logic',
    constraints: {
      maxGates: 4,
  ...
  // === 中級: 組み合わせ論理 ===
  {
    ...
    title: 'NANDの魔法',
    description:
      'NANDゲート1つだけでNOT、AND、ORを作れます。まずはNOTを作ってみましょう。',
...

  {
    ...
    title: 'XORの排他性',
    description:
      'AとBが異なる値の時だけONを出力してください。違いを検出する論理です。',
    difficulty: 'intermediate',
    category: 'logic',
    constraints: {
      maxGates: 6,
...

  {
    ...
    title: '3方向スイッチ',
    description:
      'A、B、Cの3つの入力のうち、過半数（2つ以上）がONの時にONを出力してください。',
    difficulty: 'intermediate',
    category: 'logic',
    constraints: {
      maxGates: 8,
  ...
  // === 上級: 最適化チャレンジ ===
  {
    ...
    title: 'XOR最小化',
    description:
      'XORをNANDゲートだけで作ってください。ゲート数を最小化するのが目標です。',
    difficulty: 'advanced',
...

  {
    ...
    title: 'ワンホットデコーダー',
    description:
      '2ビット入力(A,B)に対応する出力ピンだけをONにしてください。00→OUT0、01→OUT1、10→OUT2、11→OUT3',
    difficulty: 'advanced',
    category: 'logic',
    constraints: {
      maxGates: 12,
    ...
    testCases: [
      {
        inputs: [false, false],
        expectedOutput: false,
        description: '00 → OUT0のみON',
      },
      {
        inputs: [false, true],
        expectedOutput: false,
        description: '01 → OUT1のみON',
      },
      {
        inputs: [true, false],
        expectedOutput: false,
        description: '10 → OUT2のみON',
      },
      {
        inputs: [true, true],
        expectedOutput: false,
        description: '11 → OUT3のみON',
      },
    ],
