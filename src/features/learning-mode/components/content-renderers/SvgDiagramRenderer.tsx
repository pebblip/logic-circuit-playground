  ...
  if (content.diagramType === 'series-circuit') {
      ...
      <div className="svg-diagram-container">
        <svg width={width} height={height} viewBox={`0 0 ${width} ${height}`}>
          ...
          <rect
            ...
            rx="4"
          />
          <text x="50" y="105" textAnchor="middle" fill="#fff" fontSize="14">
            電源
          </text>
          ...
          <rect
            ...
            rx="4"
          />
          <text x="250" y="105" textAnchor="middle" fill="#fff" fontSize="14">
            スイッチB
          </text>
          ...
          <circle
            ...
            strokeWidth="2"
          />
          <text x="350" y="105" textAnchor="middle" fill="#fff" fontSize="20">
            💡
          </text>
        </svg>
      </div>
      ...
      <div className="svg-diagram-container">
        <svg width={width} height={height} viewBox={`0 0 ${width} ${height}`}>
          ...
          <rect
            ...
            rx="4"
          />
          <text x="170" y="65" textAnchor="middle" fill="#fff" fontSize="14">
            スイッチA
          </text>
          ...
          <rect
            ...
            rx="4"
          />
          <text x="170" y="145" textAnchor="middle" fill="#fff" fontSize="14">
            スイッチB
          </text>
    ...
    return (
      <div
        ...
        dangerouslySetInnerHTML={{ __html: content.customSvg }}
      />
    );
  }
