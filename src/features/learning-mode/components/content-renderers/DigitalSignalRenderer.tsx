      ...
      <svg viewBox="0 0 600 300" className="circuit-diagram">
        ...
        {showDigital && (
          <g>
            ...
            {/* HIGH/LOWレベル表示 */}
            <text x="100" y="145" fill="#888" fontSize="10">HIGH</text>
            <text x="100" y="235" fill="#888" fontSize="10">LOW</text>
            
            {/* 1/0表示 */}
            <text x="150" y="140" fill="#00ff88" fontSize="12">1</text>
            <text x="210" y="240" fill="#00ff88" fontSize="12">0</text>
            <text x="270" y="140" fill="#00ff88" fontSize="12">1</text>
            <text x="330" y="140" fill="#00ff88" fontSize="12">1</text>
            <text x="390" y="240" fill="#00ff88" fontSize="12">0</text>
            <text x="450" y="140" fill="#00ff88" fontSize="12">1</text>
            <text x="510" y="240" fill="#00ff88" fontSize="12">0</text>
  ...
  return (
    <div className="voltage-diagram">
      ...
      <svg viewBox="0 0 600 300" className="circuit-diagram">
        ...
        {/* 電圧レベル表示 */}
        <text x="20" y="55" fill="#fff" fontSize="12">5V</text>
        <text x="20" y="155" fill="#fff" fontSize="12">2.5V</text>
        <text x="20" y="255" fill="#fff" fontSize="12">0V</text>
        
        {/* 閾値線 */}
        <line x1="50" y1="150" x2="550" y2="150" stroke="#ff6b6b" strokeWidth="1" strokeDasharray="5,5" />
        <text x="560" y="155" fill="#ff6b6b" fontSize="12">閾値</text>
        ...
        {/* 1/0表示 */}
        <text x="120" y="280" fill="#888" fontSize="14">0</text>
        <text x="170" y="280" fill="#888" fontSize="14">1</text>
        <text x="220" y="280" fill="#888" fontSize="14">0</text>
        <text x="270" y="280" fill="#888" fontSize="14">1</text>
        <text x="320" y="280" fill="#888" fontSize="14">0</text>
        <text x="370" y="280" fill="#888" fontSize="14">1</text>
        <text x="420" y="280" fill="#888" fontSize="14">0</text>
        <text x="470" y="280" fill="#888" fontSize="14">1</text>
        
        {/* 時間軸 */}
        <text x="550" y="270" fill="#666" fontSize="12">時間 →</text>
      </svg>
    </div>
  );
};
