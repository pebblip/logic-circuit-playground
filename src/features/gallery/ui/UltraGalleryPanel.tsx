...
const AMAZING_CIRCUITS: CircuitData[] = [
  ...
  },
  {
    ...
    icon: '🧮',
    howTo:
      '💡 左の4つのスイッチで2進数を入力！上2つが数A、下2つが数B。例: 01 + 01 = 10',
    gates: [
      // 4ビット加算器の簡易版（2ビット）
  ...
  },
  {
    ...
    wires: [
      ...
      {
        id: 'w1',
        from: { gateId: 'p_paper', pinIndex: -1 },
        to: { gateId: 'win_check', pinIndex: 0 },
        isActive: false,
      },
      {
        id: 'w2',
        from: { gateId: 'c_rock', pinIndex: -1 },
        to: { gateId: 'win_check', pinIndex: 1 },
        isActive: false,
      },
      {
        id: 'w3',
        from: { gateId: 'win_check', pinIndex: -1 },
        to: { gateId: 'win', pinIndex: 0 },
        isActive: false,
      },
      ...
      {
        id: 'w4',
        from: { gateId: 'p_scissors', pinIndex: -1 },
        to: { gateId: 'lose', pinIndex: 0 },
        isActive: false,
      },
    ],
  },
...
export const UltraGalleryPanel: React.FC<{ isVisible: boolean }> = ({
  isVisible,
}) => {
