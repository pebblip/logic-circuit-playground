...
### 採用アーキテクチャ: Feature-Sliced Design + カスタムフック
...
### 状態管理
- **Zustand**: グローバル状態（回路データ）
- **Jotai**: UI状態（ホバー、選択など）
- **ViewModelパターン**: ビジネスロジックの分離
...
### 必須ドキュメント
- `CLAUDE.md`: 開発ルールと品質基準
- `README.md`: プロジェクト概要
- 本ドキュメント: 設計の全体像

### 参考資料
- `final-gate-design-perfect.html`: ゲートデザイン仕様
- `mockup-mobile-perfect.html`: モバイルUI
- `mockup-pc-perfect.html`: デスクトップUI
...
*このドキュメントは生きたドキュメントです。プロジェクトの進行に応じて更新されます。*
